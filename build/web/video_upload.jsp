<%-- 
    ...
    Created on : 23 Feb, 2022, 10:45:30 PM
    Author     : skbag
--%>
...
<body>
    ...
    <div class="sidebar">
        <div class="shortcut-links">
            ...
            <a class="active" href="video_upload.jsp"><i class="material-icons">videocam</i><span>Upload</span></a>
                ...
                <div class="login-content">
                    ...
                    <form action="retrive_viddata.jsp" method="post">
                        <div class="form-group">
                            <span>Enter Title:</span><input type="text" name="title" class="form-control" placeholder="Title of the video....">
                        </div>
                        <div class="form-group">
