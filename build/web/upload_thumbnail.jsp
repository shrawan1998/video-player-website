<%-- 
    Document   : upload_thumbnail
    Created on : 25 Feb, 2022, 12:34:56 AM
    Author     : skbag
--%>
                        ...
                        <div class="col-12">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Upload Thumbnail</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="login-content">
                                ...
                                <div class="section-heading">
                                    <h4>Let's upload thumbnail for your video!</h4>
                                    <div class="line"></div>
                                </div>

                                <form action="thumbnail_pass.jsp?code=<%=code%>" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        Upload Thumbnail <input type="file" name="thumbnail" class="form-control">
                                    </div>
