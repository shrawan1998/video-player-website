    ...
    <body>
        ...
        <div class="sidebar">
            <div class="shortcut-links">
                ...
                <a class="active" href="creater_latest.jsp"><i class="material-icons">more_time</i><span>Latest</span></a>
                <hr>
            </div>
        ...
        <div class="videos-container">
            <div class="list-container">
                <%
                    ...
                    ResultSet rs = st.executeQuery("select * from video where (email='"+email+"' AND status=1) order by sn desc limit 4");
                    while(rs.next()){
