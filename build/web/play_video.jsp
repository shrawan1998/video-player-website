...
<body>
    ...
    <nav class="flex-div">
        ...
        <div class="nav-right flex-div">
            <a href="dashboard.jsp"><i class="material-icons display-this flex-div">home</i></a>
    ...
    <div class="videos-container play-container">
        <div class="content-row">
            <%
                ...
                //taking video from video table which user wants to play
                Statement st=cn.createStatement();
                ResultSet rs=st.executeQuery("select * from video where code='"+videocode+"'");
                if(rs.next()){
                    //taking channel name and channel code from channel table
                    String channel_name="";
                    String channel_code="";
                    ...
                    //taking color of like icon from video_like table
                    String color_like="";
                    ...
                    //taking color of dislike icon from video_dislike table
                    ...
                    //taking number of likes from video_like table
                    int count_like=0;
                    ...
                    //taking number of dislikes from video_dislike table
                    int count_dislike=0;
                    ...
                    //taking color of favourite icon from video_favourite table
                    String color_fav="";
                                            ...
                                            <div class="comment-action">
                                                <%
                                                    if(email.equals(cemail)){
                                                        ...
                                                        %>
                                                        <a class="cmt_delete" id='<%=rscmt.getString("comt_code")%>' rel="<%=rs.getString("code")%>" style="cursor:pointer"><i class="fa fa-trash" aria-hidden="true" style="color: red; font-size:13px; margin-right: 20px">Delete</i></a>
                                                        <%
                                                    }
                                                %>
                                            </div>
            ...
            <div class="right-sidebar">
                <%
                    //taking random videos from video table for suggestions in right sidebar 
                    Statement stst = cn.createStatement();
                    ResultSet rsrs = stst.executeQuery("select * from video where (email='"+email+"' AND status=1 AND code<>'"+videocode+"')");
                    while(rsrs.next()){
                        String cname="";
                        ...
                        <div class="side-video-list">
                            <a href="play_video.jsp?code=<%=rsrs.getString("code")%>" class="small-thumbnail"><img src="thumbnails/<%=rsrs.getString("code")%>.jpg"></a>
                            <div class="vid-info">
                                <a href="play_video.jsp?code=<%=rsrs.getString("code")%>"><%=rsrs.getString("title")%>"</a>
                                <p><%=cname%></p>
                                <p><%=vws_count%> Views</p>
                            </div>
                        </div>
