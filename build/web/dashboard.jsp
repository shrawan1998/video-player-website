<%-- 
    Document   : dashboard
    Created on : 23 Feb, 2022, 10:36:59 PM
    Author     : skbag
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
                        ...
                        <div class="modal-body">
                            <form method="post" id="infoEdit">
                                <div class="form-group">
                                    <span>Update Title:</span><input type="text" name="title" id="title" class="form-control" placeholder="Title....">
                                    <span>Update Description:</span><textarea rows="3" cols="50" name="description" id="description" class="form-control" placeholder="Video description...." style="resize: none"></textarea>
            ...
            <!-----upload video modal----->
            <div class="modal fade" id="upload_video_Modal">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <!-- Modal Header -->
                        <div class="modal-header" style="background-color:#db4437">
                        ...
                        <div class="modal-body">
                            <form action="retrive_viddata.jsp" method="post">
                                <div class="form-group">
                                    <span>Enter Title:</span><input type="text" name="title" class="form-control" placeholder="Title....">
                                    <span>Enter Description:</span><textarea rows="3" cols="50" name="description" class="form-control" placeholder="Video description...." style="resize: none"></textarea>
                                    <button type="submit" class="btn btn-primary" id="btn">Submit</button>
                                </div>
                            </form><hr/>

                            <form action="thumbnail_pass.jsp" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <span>Upload Thumbnail:</span><br><input type="file" name="thumbnail" >
                                    <button type="submit" class="btn btn-primary">Upload</button>
                                </div>
                            </form><hr/>

                            <form action="video_pass.jsp" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <span>Upload Video:</span><br><input type="file" name="video">
                                    <button type="submit" class="btn btn-primary">Upload</button>
                                </div>
                            </form>
                        </div>
        ...
        <div class="videos-container">
            <%
            int count=0, id=0, pages=0, start=0, total=12;
            ...
            <div class="pagination" style="margin-left:500px">
                ...
                if(id>0){
                    %>
                    <a href="creater_home.jsp?id=<%=id-1%>" style="margin-left:15px; text-decoration: underline"><button style="height:20px; border: none; color: black">Pre</button></a>
                    <%
                }
                for(int i=1; i<pages; i++){
                    %>
                    <a href="creater_home.jsp?id=<%=i-1%>" style="margin-left:15px; text-decoration: underline"><button style="height:20px; border: none; color: black"><%=i%></button></a>
                    <%
                }
                if(id!=pages-1){
                    %>
                    <a href="creater_home.jsp?id=<%=id+1%>" style="margin-left:15px; text-decoration: underline"><button style="height:20px; border: none; color: black">Next</button></a>
                    <%
                }
                %>
            </div>
            <div class="list-container">
                <%
                    ...
                    ResultSet rs = st.executeQuery("select * from video where (email='"+email+"' AND status='"+show+"') order by sn desc limit "+start+","+total);
                    while (rs.next()) {
                        ...
                        <div class="vid-list" id="r-<%=rs.getString("code")%>">
                            ...
                            <div class="vid-edit">
                                <a class="edit" id="<%=rs.getString("code")%>" rel="<%=rs.getString("title")%>" pid="<%=rs.getString("description")%>" style="cursor:pointer"><i class="fa fa-edit" aria-hidden="true"></i>Edit</a>
