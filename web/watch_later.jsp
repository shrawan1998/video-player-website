<%-- 
    ...
    Created on : 2 Mar, 2022, 12:14:37 AM
    Author     : skbag
--%>
...
<head>
    ...
    <script>
        $(document).on("click",".remove",function(){
            ...
            $.post(
                    "remove_watchlater.jsp",{code:code},function(data){
                        var dt=$.trim(data);
                        if(dt=="removed"){
                            $("#f-"+code).fadeOut(1000);
                        }
            ...
            <%
                if(url.equals("creater_home.jsp")){
                   %>
                    ...
                    <a href="watch_later.jsp" class="active"><i class="material-icons">watch_later</i><span>Watch Later</span></a>
    ...
    <div class="videos-container">
        <div class="list-container">
            <%
                ...
                ResultSet rs=st.executeQuery("select * from watch_later where email='"+email+"'");
                while(rs.next()){
                    String channel_name="";
