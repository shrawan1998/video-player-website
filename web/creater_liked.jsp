<%-- 
    Document   : history
    Created on : 7 Mar, 2022, 11:05:20 AM
    Author     : skbag
--%>
...
<head>
    ...
    <script>
        $(document).on("click",".remove",function(){
            ...
            $.post(
                    "remove_liked.jsp",{code:code},function(data){
                        if(data.length==10){
                            $("#f-"+code).fadeOut(1000);
                        }
                    }
...
<body>
    ...
    <div class="sidebar">
        <div class="shortcut-links">
            ...
            <a href="creater_liked.jsp" class="active"><i class="material-icons">thumb_up</i><span>Liked Videos</span></a>
            <hr>
        </div>
    ...
    <div class="videos-container">
        <div class="list-container">
            <%
                ...
                ResultSet rs=st.executeQuery("select * from video_like where email='"+email+"'");
                while(rs.next()){
                    String channel_name="";
