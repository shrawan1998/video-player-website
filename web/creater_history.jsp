<%-- 
    Document   : history
    Created on : 6 Mar, 2022, 4:03:50 AM
    Author     : skbag
--%>
...
<head>
    ...
    <script>
        $(document).on("click",".remove",function(){
            ...
            $.post(
                    "remove_history.jsp",{code:code},function(data){
                        if(data.length==10){
                            $("#f-"+code).fadeOut(1000);
                        }
                    }
...
<body>
    ...
    <div class="sidebar">
        <div class="shortcut-links">
            ...
            <a href="creater_history.jsp" class="active"><i class="material-icons">history</i><span>History</span></a>
    ...
    <div class="videos-container">
        <div class="list-container">
            <%
                ...
                ResultSet rs=st.executeQuery("select * from history where email='"+email+"'");
                while(rs.next()){
                    String channel_name="";
