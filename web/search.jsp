...
<%
    ...
    if(email==null){
        ...
        try{
            String srch_text=request.getParameter("search");
            String titles[]=srch_text.split(" ");
            String sql="select * from video where title like '%"+srch_text+"%'";
            for(int i=0; i<titles.length; i++){
                sql=sql+" OR title like '%"+titles[i]+"%'";
            }
            sql=sql+" AND status=1";//sql query to search
            String url="";
            ...
            <%
                if(url.equals("creater_home.jsp")){
                   %>
                    ...
                    <a href="dashboard.jsp"><i class="material-icons">play_arrow</i><span>Your Videos</span></a>
                    ...
                    <a href="trending.jsp"><i class="material-icons">local_fire_department</i><span>Trending</span></a>
